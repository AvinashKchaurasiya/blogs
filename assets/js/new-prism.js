...
(function () {
      ...
      create: (function () {
        ...
        var convertToW3CRadialGradient = function (prefix, func, values) {
          if (values[0].indexOf("at") < 0) {
            ...
            if (
              ...
              if (
                shapeSizeParts[0] &&
                (shapeSizeParts[0] === "circle" ||
                  shapeSizeParts[0] === "ellipse")
              ) {
        ...
        var convertToW3CGradient = function (gradient) {
          ...
          if (func.indexOf("linear") >= 0) {
            ...
            return (cache[gradient] = convertToW3CRadialGradient(
              prefix,
              func,
              values
            ));
      ...
      create: function () {
        new Prism.plugins.Previewer(
          ...
          function (value) {
            ...
            this[(num < 0 ? "set" : "remove") + "Attribute"](
              "data-negative",
              ""
            );
            this.querySelector("circle").style.strokeDasharray =
              Math.abs(percentage) + ",500";
            return true;
          },
          "*",
          function () {
  ...
  Previewer.prototype.check = function (token) {
    ...
    do {
      if (
        tokenRegexp.test(token.className) &&
        this._clsRegexp.test(token.className)
      ) {
        break;
      }
    } while ((token = token.parentNode));
  ...
  Previewer.prototype.show = function () {
    ...
    if (this.updater.call(this._elt, this._token.textContent)) {
      ...
      this._elt.style.left =
        offset.left + Math.min(200, this._token.offsetWidth / 2) + "px";
    } else {
      this.hide();
    }
  };
  ...
  Prism.hooks.add("before-highlight", function (env) {
    for (var previewer in previewers) {
      ...
      if (
        ...
        !languages[env.language].initialized
      ) {
